...
VID.is_iDevice = function() {
    ...
    var bon_iver_playlist_Length = bon_iver_playlist.length;
    bon_iver_playlist = bon_iver_playlist.slice(0,bon_iver_playlist_Length-1);
...
player = new YT.Player('player', {
        height: '100%',
        width: '100%',
        videoId: bon_iver_channel_array[videoIndex],
        playerVars: { 'autoplay': 0, 'controls': 0, 'showinfo' : 0, 'playlist' : bon_iver_playlist, 'wmode' : 'transparent'},
        events: {
    ...
    function change_iframe_player(index) {
      ...
      if(index > bon_iver_channel_array.length - 1) {
        videoIndex = 0;
      }
      else if(index < 0) {
    ...
    function onPlayerStateChange(event) {
      if( event.data == 1 ) {
        ...
        debugger;
		test_playlist = player.getPlaylist();
        test_id = player.getPlaylistIndex();
